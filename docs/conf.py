# -*- coding: utf-8 -*-
#
# phe documentation build configuration file, created by
...
version = pkg_resources.get_distribution("phe").version
...
# of the sidebar.
html_logo = '_static/Magic-Logo.svg'
